  ...
  <div class="container">
    <div class="product-layout">
      ...
      <div class="product-info">
        <span class="category">Hommes > Pantalons</span>
        <h1>Pantalons Homme Classique</h1>
        <p class="price-tag">70 000 Ar</p>
        <p class="description">Une Pantalons élégante et confortable, parfaite pour toutes les occasions. Fabriquée avec des tissus de haute qualité pour assurer une durabilité et un style impeccable.</p>
