...
<head>
  ...
  <style>
    ...
    .btn-wish { padding: 16px 20px; border: 1px solid var(--border); border-radius: 50px; background: white; cursor: pointer; }
  ...
  <div class="container">
    <div class="product-layout">
      ...
      <div class="product-info">
        <span class="category">Hommes > Chemises</span>
        <h1>Chemise Homme Classique</h1>
        <p class="price-tag">68 000 Ar</p>
        <p class="description">Une chemise élégante et confortable, parfaite pour toutes les occasions. Fabriquée avec des tissus de haute qualité pour assurer une durabilité et un style impeccable.</p>
